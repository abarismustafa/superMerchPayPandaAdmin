            ...
            <div className="deznav">
                <div className="deznav-scroll mm-active">
                    <ul className="metismenu mm-show" id="menu">
                        ...
                        <li className="mm-active"><a className="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <ul aria-expanded="false" className="mm-collapse mm-show left" style={{}}>
                                <li className="mm-active"><Link to="bank-master" className="mm-active">Dashboard Light</Link></li>
                                {/* <li><Link to="/admin/link">Dashboard Dark</Link></li> */}
                            </ul>
                        </li>
                        <li><a href="employee.html" className aria-expanded="false">
                            <div className="menu-icon">
                        ...
                        <li><a href="core-hr.html" className aria-expanded="false">
                            <div className="menu-icon">
                                <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li><a href="finance.html" className aria-expanded="false">
                            <div className="menu-icon">
                                <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li><a href="performance.html" className aria-expanded="false">
                            <div className="menu-icon">
                                <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li><a href="project.html" className aria-expanded="false">
                            <div className="menu-icon">
                                <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li><a href="reports.html" className aria-expanded="false">
                            <div className="menu-icon">
                                <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li><a href="manage-client.html" className aria-expanded="false">
                            <div className="menu-icon">
                                <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li><a href="blog-1.html" className aria-expanded="false">
                            <div className="menu-icon">
                                <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M11.9946 16.0001V12.0001" stroke="#888888" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M11.9896 8.20435H11.9996" stroke="#888888" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </div>
                        ...
                        <li><a href="svg-icon.html" className aria-expanded="false">
                            <div className="menu-icon">
                                <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="nav-text">SVG Icons</span>
                            <span className="badge badge-danger badge-xs ms-1">NEW</span>
                        </a>
                        </li>
                        ...
                        <li><a className="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <span className="nav-text">Apps <span className="badge badge-danger badge-xs ms-1">NEW</span></span>
                        </a>
                            <ul aria-expanded="false" className="mm-collapse left" style={{}}>
                                <li><a href="chat.html">Chat<span className="badge badge-danger badge-xs ms-1">NEW</span></a></li>
                                <li><a className="has-arrow" href="javascript:void(0);" aria-expanded="false">Users Manager<span className="badge badge-danger badge-xs ms-1">NEW</span></a>
                                    <ul aria-expanded="false" className="mm-collapse left" style={{}}>
                                        ...
                                        <li><a href="app-profile-2.html">Profile 2 <span className="badge badge-danger badge-xs ms-1">NEW</span></a></li>
                                        <li><a href="edit-profile.html">Edit Profile</a></li>
                                        <li><a href="post-details.html">Post Details</a></li>
                                    </ul>
                                </li>
                                <li><a className="has-arrow" href="javascript:void(0);" aria-expanded="false">Customer Manager<span className="badge badge-danger badge-xs ms-1">NEW</span></a>
                                    <ul aria-expanded="false" className="mm-collapse left" style={{}}>
                                        <li><a href="customer.html">Customer</a></li>
                                        <li><a href="customer-profile.html">Customer Profile</a></li>
                                    </ul>
                                </li>
                                <li><a href="contacts.html">Contacts <span className="badge badge-danger badge-xs ms-1">NEW</span></a></li>
                        ...
                        <li><a className="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <span className="nav-text">AIKit<span className="badge badge-danger badge-xs ms-1">NEW</span></span>
                        </a>
                            <ul aria-expanded="false" className="mm-collapse left" style={{}}>
                        ...
                        <li><a className="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <span className="nav-text">CMS<span className="badge badge-danger badge-xs ms-1">NEW</span></span>
                        </a>
                            <ul aria-expanded="false" className="mm-collapse left" style={{}}>
                        ...
                        <li><a className="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <ul aria-expanded="false" className="mm-collapse left" style={{}}>
                                ...
                                <li className="extra-menu-li">
                                    <ul id="collapseExample" className="pt-0 extra-menu-links extra-menu-area mm-collapse left" style={{}}>
