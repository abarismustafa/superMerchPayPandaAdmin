                                            ...
                                            <form className="tbl-captionn" onSubmit={handleSubmit}>
                                                <div className="row">
                                                    <div className="col-xl-6 mb-3">
                                                        <select className="form-select" aria-label="Default select example" id="service_id" name="service_id" value={values.service_id} onChange={handleChange}
                                                            hasError={
                                                    ...
                                                    <div className="col-xl-6 mb-3">
                                                        <select className="form-select" aria-label="Default select example" id="area_id" name="area_id" value={values.area_id} onChange={changeHandleArea}
                                                            hasError={
