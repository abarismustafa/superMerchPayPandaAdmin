...
function PerformanceReportList() {
    return (
                                    ...
                                    <table id="empoloyees-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="empoloyees-tblwrapper_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                Mapped Parent </th>
                                                <th className="sorting" tabIndex={0} aria-controls="empoloyees-tblwrapper" rowSpan={1} colSpan={1} aria-label="Status: activate to sort column ascending" style={{ width: '96.125px' }}>
                                                Mapped Parent Type</th>
                                                <th className="sorting" tabIndex={0} aria-controls="empoloyees-tblwrapper" rowSpan={1} colSpan={1} aria-label="Contact Number: activate to sort column ascending" style={{ width: '161.675px' }}>
                                                Main Parent</th>
                                                <th className="sorting" tabIndex={0} aria-controls="empoloyees-tblwrapper" rowSpan={1} colSpan={1} aria-label="Status: activate to sort column ascending" style={{ width: '96.125px' }}>
                                                Main Parent Type</th>
                                                <th className="sorting" tabIndex={0} aria-controls="empoloyees-tblwrapper" rowSpan={1} colSpan={1} aria-label="Contact Number: activate to sort column ascending" style={{ width: '161.675px' }}>
                                                Transaction Turnover</th>
                                                <th className="sorting" tabIndex={0} aria-controls="empoloyees-tblwrapper" rowSpan={1} colSpan={1} aria-label="Status: activate to sort column ascending" style={{ width: '96.125px' }}>
                                                Commission Transferred</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr role="row" className="odd">
                                                ...
                                                <td>
                                                    <span className="badge badge-success light border-0">DMT</span>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                            <tr role="row" className="odd">
                                                ...
                                                <td>
                                                    <span className="badge badge-success light border-0">BBPS</span>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                            <tr role="row" className="odd">
                                                ...
                                                <td>
                                                    <span className="badge badge-success light border-0">AEPS</span>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
