...
// 				 		Txn Amount	Response Message	Status	Receipt
// No matching records found
function AepsTezReportList() {
  return (
                ...
                <div className="card-body p-0">
                    <div className="table-responsive active-projects style-1">
                        <div className="tbl-caption">
                            <h4 className="heading mb-0"><b> Aeps Tez Report</b></h4>
                            <div>
...
export default AepsTezReportList