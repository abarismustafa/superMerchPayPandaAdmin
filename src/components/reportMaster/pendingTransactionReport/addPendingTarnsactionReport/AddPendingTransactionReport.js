                            ...
                            <form className="tbl-captionn">
                                <div className="row">
                                    ...
                                    <div className="col-xl-4 mb-3">
                                        ...
                                        <input type="date" className="form-control" id="exampleFormControlInput2" placeholder="First Name" />
                                    </div>
                                    <div className="col-xl-4 mb-3">
                                        <label htmlFor="exampleFormControlInput2" className="form-label">Middle Name<span className="text-danger">*</span></label>
                                        <input type="date" className="form-control" id="exampleFormControlInput2" placeholder="Middle Name" />
                                    </div>
                                    <div className="col-xl-4 mb-3">
                                    ...
                                    <div className="col-xl-4 mb-3">
                                        <label htmlFor="exampleFormControlInput2" className="form-label">	Vendor	<span className="text-danger">*</span></label>
                                        <input type="number" className="form-control" id="exampleFormControlInput2" placeholder="Vendor" />
                                    </div>
