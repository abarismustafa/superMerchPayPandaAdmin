        ...
        <div className="row">
          <div className="col-xl-4 mb-3">
            <label htmlFor="exampleFormControlInput2" className="form-label">
              Housing Society Services<span className="text-danger">*</span>
            </label>
          ...
          <div className="col-xl-4 mb-3">
            <label htmlFor="exampleFormControlInput2" className="form-label">
              Cable TV Services<span className="text-danger">*</span>
            </label>
            <select id="disabledSelect " className=" form-select select2">
              <option disabled value={true}>
                {" "}
          ...
          <div className="col-xl-4 mb-3">
            <label htmlFor="exampleFormControlInput2" className="form-label">
              LPG Gas Services<span className="text-danger">*</span>
            </label>
            <select id="disabledSelect " className=" form-select select2">
              <option disabled value={true}>
                {" "}
          ...
          <div className="col-xl-4 mb-3">
            <label htmlFor="exampleFormControlInput2" className="form-label">
              Pancard Services<span className="text-danger">*</span>
            </label>
            <select id="disabledSelect " className=" form-select select2">
              <option disabled value={true}>
                {" "}
